  ...
  <div class="rounded-2xl bg-gradient-to-r from-primary/10 to-primary/5 border border-border p-6">
    ...
    >
      ...
      <div v-else key="content" class="space-y-4">
        ...
        <h1 class="text-2xl font-heading font-bold">Resume & Cover Letter</h1>
        <p class="text-muted-foreground max-w-2xl">
          Create compelling resumes and cover letters that stand out to employers and pass ATS systems.
        </p>
      </div>
    </Transition>
  </div>
